...
import { faqs, serverRequirements } from '../../data/tiktok/tiktokData.js'
        ...
        <div className="vc_column-inner">
          <div className="wpb_wrapper">
            <div className="wpb_wrapper-inner">
              ...
              <header className="fancy-title">
                <p>TikTok Clone FAQ</p>
                <h3>Get answers for all your queries about our TikTok Clone Script with our comprehensive FAQ section.</h3>
              </header>
...
export default function FaqServerTabs() {
  ...
  return (
    <section className="vc_row wpb_row vc_row-fluid liquid-row-shadowbox tiktok-faq-panel">
