                  ...
                  <div className="wpb_single_image wpb_content_element vc_align_center">
                    <figure className="wpb_wrapper vc_figure">
                      <div className="vc_single_image-wrapper vc_box_border_grey">
                        <img src="/wp-content/uploads/2026/04/website-aboutus-1.webp" width="650" height="583" className="vc_single_image-img attachment-full" alt="website-aboutus" title="website-aboutus-1" />
                      </div>
                    </figure>
                  </div>
                </div>
