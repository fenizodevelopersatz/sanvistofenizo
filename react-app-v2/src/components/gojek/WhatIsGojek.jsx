...
export default function WhatIsGojek() {
  return (
    <>
                    ...
                    <div className="wpb_single_image wpb_content_element vc_align_center">
                      <figure className="wpb_wrapper vc_figure">
                        <div className="vc_single_image-wrapper vc_box_border_grey">
                          <img src="/wp-content/uploads/2025/08/gojek-hiw.webp" width="484" height="550" alt="gojek-hiw" loading="lazy" />
                        </div>
                      </figure>
                    </div>
                  </Reveal>
                ...
                <div className="wpb_wrapper">
                  <Reveal as="div" className="wpb_wrapper-inner" direction="left">
                    <div className="wpb_single_image wpb_content_element vc_align_center">
                      <figure className="wpb_wrapper vc_figure">
                        <div className="vc_single_image-wrapper vc_box_border_grey">
                          <img src="/wp-content/uploads/2025/02/why-choose.png" width="494" height="455" className="vc_single_image-img attachment-full" alt="Grow your all-in-one service business with CloneScript" loading="eager" decoding="async" />
                        </div>
                      </figure>
                    </div>
                  </Reveal>
