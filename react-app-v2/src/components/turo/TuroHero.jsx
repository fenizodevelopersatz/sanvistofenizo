export default function TuroHero() {
  return (
              ...
              <div className="wpb_wrapper">
                <div className="wpb_wrapper-inner">
                  <div className="iconbox iconbox-inline iconbox-heading-xs" style={{ justifyContent: 'center' }}>
                    <div className="iconbox-icon-wrap"><span className="iconbox-icon-container"><i className="fa fa-solid fa-bolt"></i></span></div>
                  ...
                  <div className="wpb_single_image wpb_content_element vc_align_center">
                    <figure className="wpb_wrapper vc_figure">
                      <div className="vc_single_image-wrapper vc_box_border_grey">
                        <img src="/wp-content/uploads/2026/05/car-rental-script.webp" width="1729" height="1030" className="vc_single_image-img attachment-full" alt="car-rental-script" title="car-rental-script" loading="lazy" />
                      </div>
                    </figure>
                  </div>
                </div>
