                ...
                <Reveal as="div" className="wpb_wrapper-inner" duration={1.2}>
                  <div className="ld-fancy-heading text-center">
                    <h1 className="lqd-highlight-underline lqd-highlight-grow-left">
                      <span className="ld-fh-txt"> <span style={{ color: '#ffc53c' }}>#1 Uber </span>Clone App</span>
                    </h1>
                  </div>
                  <div className="wpb_text_column wpb_content_element">
                    <div className="wpb_wrapper">
                      <p style={{ textAlign: 'center' }}>Uber Clone is a ready-made taxi app development solution that helps to launch an app like Uber with multiple features and a user-friendly interface.</p>
                    </div>
                  </div>
