    ...
    <section className="vc_row wpb_row vc_row-fluid liquid-row-shadowbox">
      <div className="ld-container container">
        <div className="row ld-row vc_row-o-content-middle vc_row-flex">
          <div className="wpb_column vc_column_container vc_col-sm-6 vc_col-md-6 vc_hidden-sm vc_hidden-xs">
                  ...
                  <div className="wpb_single_image wpb_content_element vc_align_left">
                    <figure className="wpb_wrapper vc_figure">
                      <div className="vc_single_image-wrapper vc_box_border_grey">
                        <img src="/wp-content/uploads/2025/09/olx-clone-script.webp" width="658" height="594" className="vc_single_image-img attachment-full" alt="olx-clone-script" title="olx-clone-script" />
                      </div>
                    </figure>
                  </div>
                </div>
