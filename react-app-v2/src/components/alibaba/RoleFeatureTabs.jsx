...
import { roleTabs } from '../../data/alibaba/alibabaData.js'
...
export default function RoleFeatureTabs() {
  return (
            ...
            <div className="vc_column-inner">
              <div className="wpb_wrapper">
                <div className="wpb_wrapper-inner">
                  ...
                  <h3 style={{ textAlign: 'center' }} className="vc_custom_heading">Alibaba Software Multiple Stunning Features</h3>
                  <div className="wpb_text_column wpb_content_element">
                    <div className="wpb_wrapper">
                      <p style={{ textAlign: 'center' }}>Our Whitelabel Alibaba clone will help you to boost your business in the fastest possible way.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="wpb_wrapper-inner">
                  <div id="fixed-menu" className="lqd-custom-menu text-center fixed-menu">
                    <ul className="reset-ul inline-nav menu-items-have-fill">
                      {Object.entries(roleTabs).map(([key, role]) => (
