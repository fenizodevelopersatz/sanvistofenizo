                  ...
                  <div className="wpb_single_image wpb_content_element vc_align_left">
                    <figure className="wpb_wrapper vc_figure">
                      <div className="vc_single_image-wrapper vc_box_border_grey">
                        <img src="/wp-content/uploads/2026/01/application.webp" width="400" height="62" className="vc_single_image-img attachment-full" alt="application" title="application" loading="lazy" />
                      </div>
                    </figure>
                  </div>
                </div>
              ...
              <div className="wpb_wrapper">
                <div className="wpb_wrapper-inner">
                  <div className="wpb_single_image wpb_content_element vc_align_right">
                    <figure className="wpb_wrapper vc_figure">
                      <div className="vc_single_image-wrapper vc_box_border_grey">
                        <img src="/wp-content/uploads/2026/01/app-img.webp" width="350" height="454" className="vc_single_image-img attachment-full" alt="app-img" title="app-img" loading="lazy" />
                      </div>
                    </figure>
                  </div>
                </div>
