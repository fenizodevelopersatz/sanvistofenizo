export default function BookDemoCta() {
  return (
    <section id="pdf" className="vc_row wpb_row vc_row-fluid vc_row-o-content-middle vc_row-flex">
                  ...
                  <div className="wpb_single_image wpb_content_element vc_align_center">
                    <figure className="wpb_wrapper vc_figure">
                      <div className="vc_single_image-wrapper vc_box_border_grey">
                        <img src="/wp-content/uploads/2026/01/book-demo.webp" width="427" height="369" className="vc_single_image-img attachment-full" alt="book-demo" title="book-demo" loading="lazy" />
                      </div>
                    </figure>
                  </div>
                </div>
