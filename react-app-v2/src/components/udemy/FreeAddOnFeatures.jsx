import { freeAddOnFeatures } from '../../data/udemy/udemyData.js'

export default function FreeAddOnFeatures() {
  return (
          ...
          {freeAddOnFeatures.map((f, i) => (
            <div className="wpb_column vc_column_container vc_col-sm-4 vc_col-md-4 vc_col-sm-offset-0 vc_col-xs-offset-1 vc_col-xs-10" key={i}>
              <div className="vc_column-inner">
                <div className="wpb_wrapper">
                  <div className="wpb_wrapper-inner">
                    <div className="ld-flipbox ld-flipbox-shadow-onhover round flip-box-border-udemy">
                      <div className="ld-flipbox-wrap">
                        <div className="ld-flipbox-face ld-flipbox-front">
                          ...
                          <div className="ld-flipbox-inner">
                            <div className="iconbox iconbox-heading-md" style={{ color: '#ff64f9' }}>
                        ...
                        <div className="ld-flipbox-face ld-flipbox-back">
                          ...
                          <div className="ld-flipbox-inner">
                            <div className="wpb_text_column wpb_content_element">
                              <div className="wpb_wrapper">
                                <p style={{ textAlign: 'center' }}><span style={{ color: '#101b48' }}>{f.desc}</span></p>
                              </div>
                            </div>
                          </div>
                        </div>
