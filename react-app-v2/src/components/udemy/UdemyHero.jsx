...
export default function UdemyHero() {
  return (
              ...
              <div className="wpb_wrapper">
                <Reveal as="div" className="wpb_wrapper-inner" duration={1.2}>
                  ...
                  <div className="iconbox iconbox-inline iconbox-heading-xs" style={{ justifyContent: 'center' }}>
                    ...
                    <h3 className="font-weight-semibold">AI Integrated</h3>
                  </div>
              ...
              <div className="wpb_wrapper">
                <div className="wpb_wrapper-inner">
                  <div className="wpb_single_image wpb_content_element vc_align_center">
                    <figure className="wpb_wrapper vc_figure">
                      <div className="vc_single_image-wrapper vc_box_border_grey">
                        <img src="/wp-content/uploads/2025/09/udemy-3.webp" width="895" height="540" className="vc_single_image-img attachment-full" alt="udemy-clone" title="udemy-clone" loading="lazy" />
                      </div>
                    </figure>
                  </div>
                </div>
