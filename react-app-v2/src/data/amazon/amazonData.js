...
export const generalIconFeatures = [
  { icon: 'fas fa-coins', title: 'Multiple Payment' },
  { icon: 'fas fa-dollar-sign', title: 'Multiple Currency' },
  { icon: 'fas fa-search', title: 'SEO Friendly' },
  { icon: 'fas fa-funnel-dollar', title: 'Advanced Search and Filters' },
  { icon: 'fas fa-sign-in-alt', title: 'Social Login' },
]

export const platformRows = [
  {
    title: 'WordPress Framework',
    tagline: 'WordPress is a popular CMS That Acts As A Robust Framework For Creating And Managing eCommerce Websites',
    points: [
      'WordPress has a user-friendly interface that allows one to easily build and manage an eCommerce website. It offers a wide range of plugins and customization options to fit the website for your business needs.',
      'WordPress is a cost-effective solution that scales with your business and offers third-party integration options for enhanced functionalities.',
    ],
    image: '/wp-content/uploads/2024/12/group-48095515-674da68861f68.webp',
    imageAlt: 'wordpress framework',
    imagePosition: 'right',
  },
  {
    title: 'WooCommerce',
    tagline: 'Right Choice For Managing an eCommerce Store And Selling Products',
    points: ['WooCommerce offers a range of customization options, from layouts to color schemes, and payment gateway integration, allowing you to make your eCommerce website fit your brand.'],
    image: '/wp-content/uploads/2024/12/group-48095511-674da684da1db.webp',
    imageAlt: 'woocommerce',
    imagePosition: 'left',
  },
  {
    title: 'Elementor',
    tagline: 'Widely Used WordPress Page Builder to Create Custom Pages And Layouts',
    points: [
      'Create and design your eCommerce website with an intuitive drag-and-drop interface, which reduces the requirement for coding knowledge so that, beginners can use it seamlessly.',
      'It lets you use the range of pre-built templates, and widgets to create versatile content and simple layout customization. Also, it comes with features like responsive design, WooCommerce integration and more.',
    ],
    image: '/wp-content/uploads/2024/11/group-2787-6749b55967e59.webp',
    imageAlt: 'elementor',
    imagePosition: 'right',
  },
  {
...
export const pricingPlans = [
  {
    ...
    features: [
      ['1 Domain license', true], ['One-Time Payment', true], ['100% Source Code', true], ['3 Months Support', true], ['Unlimited Updates', true],
      ['Free Installation', true], ['Android Webview App', true], ['iOS Webview App', true], ['Mobile App Submission', true], ['Access All Features', true],
    ],
  },
  {
    name: 'Startup', price: '$1199', featured: false,
    features: [
      ['1 Domain license', true], ['One-Time Payment', true], ['100% Source Code', true], ['3 Months Support', true], ['Unlimited Updates', true],
      ['Free Installation', true], ['Access All Features', true],
      ['Android Webview App', false], ['iOS Webview App', false], ['Mobile App Submission', false],
    ],
  },
]
