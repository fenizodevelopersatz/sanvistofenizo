...
export const roleTabs = {
  user: {
    ...
    tabs: [
      ...
      { icon: 'fa fa-regular fa-calendar', title: 'Flexible Property Visit Booking', image: '/wp-content/uploads/2026/04/property-schedule.webp' },
  ...
  seller: {
    ...
    tabs: [
      ...
      { icon: 'fa fa-solid fa-receipt', title: 'Payment & Transaction History', image: '/wp-content/uploads/2026/04/invoice.webp' },
