...
export const faqs = [
  { q: 'What Is a TikTok Clone?', a: 'A TikTok Clone is a ready-made video-sharing app that replicates core TikTok features such as short-video creation, uploading, editing, live streaming, likes, comments, and sharing. With Fenizo’s TikTok Clone Script, entrepreneurs can quickly launch their own branded short-video platform without building everything from scratch.' },
  ...
  { q: 'Why Do Entrepreneurs Choose Fenizo’s TikTok Clone Script?', a: 'Entrepreneurs choose Fenizo because it offers faster launch within a week, lower development cost, proven market-ready features, full customization and branding, and built-in monetization options. This allows businesses to enter the booming short-video market quickly and gain a competitive edge without technical complexity.' },
  { q: 'How Much Does It Cost to Build a TikTok Clone App?', a: 'The cost of a TikTok Clone app depends on your feature requirements and customizations. Fenizo offers affordable and flexible pricing, making it ideal for startups and growing businesses. Advanced features such as AI-based recommendations, live streaming, virtual gifts, and monetization modules can be added based on your business goals.' },
  { q: 'How Fast Can I Launch a TikTok Clone App with Fenizo?', a: 'With Fenizo, you can launch your TikTok-like video-sharing app in as little as 7 days. Our team takes care of setup, customization, deployment, and technical support—ensuring a smooth and quick go-to-market experience.' },
